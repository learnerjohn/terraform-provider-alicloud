...
* `backend_model_data` - (Required) The backend model data in JSON format. The structure varies by backend type:
  * **HTTP**: `{"ServiceAddress":"http://...","HttpTargetHostName":"www.example.com","ServiceTimeout":30}`
  * **VPC**: `{"VpcConfig":{"VpcAccessId":"...","VpcScheme":"","VpcTargetHostName":"www.host.com"}}`
  * **FunctionCompute**: `{"FunctionComputeConfig":{"FcRegionId":"cn-hangzhou","FcType":"FCEvent","ServiceName":"...","FunctionName":"...","RoleArn":"...","FcVersion":"2.0"}}`
  * **OSS**: `{"OssConfig":{"OssRegionId":"cn-hangzhou","BucketName":"...","Key":"...","Action":"..."}}`
  * **EventBridge**: `{"EventBridgeConfig":{"EventBus":"...","EventBridgeRegionId":"cn-hangzhou","RoleArn":"..."}}`
  * **MOCK**: `{"MockConfig":{"MockResult":"mock result"}}`
